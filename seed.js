...
// ─── Safety Guard ────────────────────────────────────────
var isProduction = MONGODB_URI.includes('mongodb+srv');
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, mongoose_1.default.createConnection("".concat(MONGODB_URI, "/user-service")).asPromise()];
                case 1:
                    userConn = _b.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, mongoose_1.default.createConnection("".concat(MONGODB_URI, "/product-service")).asPromise()];
                case 4:
                    productConn = _b.sent();
